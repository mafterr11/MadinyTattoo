                ...
                return (
                  ...
                  >
                    <div className='flex items-center justify-center relative overflow-hidden group'>
                      ...
                      />
                      {/* overlay gradient */}
                      <div className='absolute inset-0 bg-gradient-to-l from-transparent via-[#50484f] to-[#2f2942] opacity-0 group-hover:opacity-80 transition-all duration-300'></div>
                      {/* title */}
