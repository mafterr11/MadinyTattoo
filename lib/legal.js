 ...
 * loads the Google Maps embed on /contact along with the page. Change any of
 * that and the pages have to change with it; the values below are the parts
 * that depend on the business rather than on the code.
 *
