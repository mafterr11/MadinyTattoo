...
/**
 * The headline score and total, exactly as the Google profile shows them.
 *
 * `count` is the number of reviews on the profile, not the number displayed
 * here — that is what AggregateRating is meant to describe, and it is the
 * figure a visitor can check for themselves by opening the profile.
 *
 * @type {{ score: number, count?: number } | null}
 */
export const googleRating = { score: 5, count: 95 };
