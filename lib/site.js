...
/** Single source shared with next-sitemap.config.js — see lib/siteUrl.js. */
...
export const business = {
  ...
  tagline:
    "Salon de tatuaje, micropigmentare, laser removal și piercing în București",
  phone: "+40741620774",
...
const whatsappPhone = business.phone.replace("+", "");

export const whatsappUrl = `https://wa.me/${whatsappPhone}`;
export const whatsappSendUrl = `https://api.whatsapp.com/send/?phone=${whatsappPhone}&type=phone_number&app_absent=0`;
...
// The reviews live on the homepage, under #testimoniale. The dedicated
// /testimoniale page it replaced is 301'd there in next.config.js — that
// redirect is the only thing still keeping the old URL alive.
