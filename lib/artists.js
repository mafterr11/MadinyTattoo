...
export const artists = [
  {
    ...
    /**
     * Head crop, for the portfolio filter and the booking wizard — a
     * full-length portrait is unreadable at 28px.
     *
     * Not a crop of `photo`: hers is cut from an earlier colour sitting
     * because it reads better small and sits beside Alexandra's without one
     * of the two being the only face in black and white. Replacing `photo`
