  ...
  return (
    <div className="relative">
      ...
      <div className="hidden md:flex items-center justify-between w-full absolute inset-y-0  px-4 text-5xl cursor-pointer">
        <SlArrowLeft class="swiper-navigation-prev absolute -left-[10%] top-[44%] text-accent" />
        <SlArrowRight type="button" class="swiper-navigation-next absolute -right-[10%] top-[44%] text-accent"/>
      </div>
    </div>
  );
};
